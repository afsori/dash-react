...
function Login() {
  ...
  return (
    ...
    <div className="row">
        ...
        <div className="col-xxl-7 col-lg-6 bg-blue text-center pt-lg-5 pb-lg-145 d-lg-block d-none">
            <img src={HeaderImg} width="502" height="391.21" className="img-fluid pb-50" alt=""/>
